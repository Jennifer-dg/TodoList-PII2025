...
namespace TodoList
{
    public partial class Form1 : Form
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            foreach (var tarea in tareas.Where(t => t.Nombre.Contains(txtBoxBuscar.Text, StringComparison.OrdinalIgnoreCase)))
                flowPanelTodoList.Controls.Add(crearTarjeta(tarea));
        }
        }
    }
